...
A username should be found by gathering information > hydra -l zahid -P password-list.txt ssh:// Ip 
hydra -l zahid-username.txt -P password-list.txt ssh:// Ip 

Linux has some passwords stored for viewing > ls /usr/share/wordlists
github password list: https://github.com/danielmiessler/SecLists

hydra -l admin -P /usr/share/wordlists/fasttrack.txt smb://ip


If I want to see how many devices are connected to a router > netdiscover -i ip
